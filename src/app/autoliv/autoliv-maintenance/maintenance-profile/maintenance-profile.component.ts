...
@Component({
  ...
  templateUrl: './maintenance-profile.component.html',
  styleUrl: './maintenance-profile.component.less'
})
export class MaintenanceProfileComponent implements OnInit {
  ...
  public onUploadProfile(v: NzUploadChangeParam): void {
