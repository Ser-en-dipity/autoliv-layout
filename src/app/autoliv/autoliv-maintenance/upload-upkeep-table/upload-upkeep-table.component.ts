...
@Component({
  selector: 'app-upload-upkeep-table',
  templateUrl: './upload-upkeep-table.component.html',
  styleUrl: './upload-upkeep-table.component.less'
})
export class UploadUpkeepTableComponent implements OnInit {
  ...
  public onUploadUpKeep(v: NzUploadChangeParam): void {
